          ...
          <div className={`flex flex-col space-y-3 w-full h-full ${data != null && "md:mr-3"}`}>
            ...
            <div className={`flex flex-row p-3 ${data !== null ?  "justify-between" : "justify-center"}`}>
              ...
              <div className="flex flex-col justify-center items-center">
                <div className="text-xl mb-3 text-center space-y-3"><p>Welcome to WeatherWise, your personal weather station.</p> <p>Discover current conditions, see hourly trends, and plan your week with a seven-day forecast.</p> <p>Start by entering a city name in the search bar.</p></div>
              </div>
              )}
